...
# - date         : 2012-05-14
# - version      : 1.3
# - usage        : bash rsrsyncclone.sh
# - OS Supported : Ubuntu, Debian, SUSE, Gentoo, RHEL, CentOS
# - Version 0.01
#### ========================================================================== ####

# The IP address of the target, this can be specified from the command line if you like
TIP="$1"
...
QUIT
echo "So I quit, and deleted all of the temp files I made."
...
echo "Which may involve PEM files, keys or other assorted means."
echo ''
...
echo ''
echo "However, I have Great success in migrating"
